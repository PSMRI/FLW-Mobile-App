...
import org.piramalswasthya.sakhi.adapters.FilariaMemberListAdapter
...
@AndroidEntryPoint
class FilariaSuspectedListFragment : Fragment() {
    private var _binding: FragmentDisplaySearchRvButtonBinding? = null
    private val binding: FragmentDisplaySearchRvButtonBinding
        get() = _binding!!

    private val viewModel: FilariaSuspectedViewModel by viewModels()
    ...
    override fun onStart() {
        ...
        activity?.let {
            (it as HomeActivity).updateActionBar(
                R.drawable.ic__hh,
                getString(R.string.icon_title_Filaria)
            )
        }
    }
