    ...
    class HBNCFormViewModel @Inject constructor(private val repository: FormRepository) : ViewModel() {
        ...
        fun loadSyncedVisitList(benId: Long) {
            viewModelScope.launch {
                ...
                Log.d("SyncedVisitCheck", "Found ${list.size} benid: $benId visits: ${list.map { it.visitDay }}")
        ...
        fun loadFormSchema(benId: Long,formId: String, visitDay: String, viewMode: Boolean) {
            ...
            viewModelScope.launch {
                ...
                Log.d("HBNCFormViewModel", "Schema load failed benId: $benId visitDat:$visitDay")
...
//                }
        ...
        fun saveFormResponses(benId: Long,hhId: Long) {
            viewModelScope.launch {
                ...
                Log.d("FormSaveBenHHd", "BenId:$benId hhId: $hhId")
        ...
        fun loadInfant(benId: Long, hhId: Long) {
            this.benId = benId
            this.hhId = hhId
            Log.e("Infat_se:", "❌ beID=${benId} hhId: $hhId")
            viewModelScope.launch {
...
fun getVisitCardList(): List<VisitCard> {
    ...
    // ✅ Filter visit history for only current benId
    val relevantVisits = _syncedVisitList.value.filter { it.benId == currentBenId }

    val completed = relevantVisits.map { it.visitDay }.toSet()

    Log.d("VisitCardList", "✅ Generating visit cards for benId=$currentBenId")
    Log.d("VisitCardList", "📝 Completed visits: $completed")
