...
import org.piramalswasthya.sakhi.databinding.FragmentPulsePolioCampaignFormBinding
...
class PulsePolioCampaignFormFragment : Fragment() {
    ...
    private var _binding: FragmentPulsePolioCampaignFormBinding? = null
    private val binding: FragmentPulsePolioCampaignFormBinding
        get() = _binding!!

    private val viewModel: PulsePolioCampaignViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPulsePolioCampaignFormBinding.inflate(layoutInflater)
        return binding.root
    }
