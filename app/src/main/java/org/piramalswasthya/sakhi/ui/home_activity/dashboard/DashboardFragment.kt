...
import org.piramalswasthya.sakhi.databinding.ItemDashboardStatCardBinding
...
class DashboardFragment : Fragment() {
    ...
    private fun setupCard(card: ItemDashboardStatCardBinding, label: String, iconRes: Int) {
        card.tvStatLabel.text = label
        card.ivStatIcon.setImageResource(iconRes)
    }

    private fun setCount(card: ItemDashboardStatCardBinding, count: Int) {
        card.tvStatCount.text = count.toString()
    }
