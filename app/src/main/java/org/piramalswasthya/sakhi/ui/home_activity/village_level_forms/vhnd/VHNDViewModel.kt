...
//        get() = _placeVHND
    ...
    init {
        viewModelScope.launch {
            ...
            _vhndCache = VHNDCache(id = 1, vhndDate = "");
            val vhndIds = vlfReo.getVHND(vhndId)
//            val vhndIds = vlfReo.getVHND(vhndId)?.also { vhndId ->
//                _dateVHND.value = "${vhndId.vhndDate}"
//                _placeVHND.value = "${vhndId.place}"
//                _noOfBenAttVHND.value="${vhndId.noOfBeneficiariesAttended.toString()}"
//                }
