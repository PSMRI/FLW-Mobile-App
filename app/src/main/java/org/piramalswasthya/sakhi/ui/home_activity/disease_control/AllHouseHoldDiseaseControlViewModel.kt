...
@HiltViewModel
class AllHouseHoldDiseaseControlViewModel @Inject constructor(
    savedStateHandle: SavedStateHandle,
    private val householdRepo: HouseholdRepo, recordsRepo: RecordsRepo

) : ViewModel() {

    val diseaseType = AllHouseHoldDiseaseControlFragmentArgs.fromSavedStateHandle(savedStateHandle).diseaseType
