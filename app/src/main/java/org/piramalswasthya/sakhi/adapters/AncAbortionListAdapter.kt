...
class AncAbortionListAdapter(private val clickListener: AbortionListClickListener? = null) :
    ListAdapter<BenWithAncListDomain, AncAbortionListAdapter.PregnancyVisitViewHolder>(
        MyDiffUtilCallBack
    ) {
    ...
    class PregnancyVisitViewHolder private constructor(private val binding: RvItemAbortionBinding) :
        ...
        fun bind(
            item: BenWithAncListDomain, clickListener: AbortionListClickListener?
        ) {
            binding.visit = item
