...
import org.piramalswasthya.sakhi.databinding.RvItemIconBinding
...
class IconAdapter(
    ...
    ListAdapter<Icon, IconAdapter.IconViewHolder>(IconDiffCallback) {
    ...
    class IconViewHolder private constructor(private val binding: RvItemIconBinding) :
        RecyclerView.ViewHolder(binding.root) {

        companion object {
            fun from(parent: ViewGroup): IconViewHolder {
                val layoutInflater = LayoutInflater.from(parent.context)
                val binding = RvItemIconBinding.inflate(layoutInflater, parent, false)
