...
class AESSuspectedViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: AESSuspectedViewModel
    ...
    override fun setUp() {
        super.setUp()
        every { recordsRepo.aesScreeningList(any()) } returns flowOf(emptyList())
        viewModel = AESSuspectedViewModel(recordsRepo, savedStateHandle)
    }
