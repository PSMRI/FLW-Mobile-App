...
class KalaAzarSuspectedListFragmentNavigationTest {
    ...
    private fun args() = KalaAzarSuspectedListFragmentArgs(hhId = 10L, fromDisease = 21, diseaseType = "v3")
    ...
    fun dataClassSynthetics_behaveAsValueType() {
        ...
        assertTrue(a.toString().contains("KalaAzarSuspectedListFragmentArgs"))
    ...
    fun toSavedStateHandle_thenFromSavedStateHandle_roundTrips() {
        ...
        assertEquals(args(), KalaAzarSuspectedListFragmentArgs.fromSavedStateHandle(handle))
    }

    @Test
    fun fromSavedStateHandle_throws_whenRequiredArgumentMissing() {
        assertThrows(IllegalArgumentException::class.java) {
            KalaAzarSuspectedListFragmentArgs.fromSavedStateHandle(SavedStateHandle())
        }
    }
    ...
    fun fromSavedStateHandle_throws_whenRequiredArgumentIsNull() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            KalaAzarSuspectedListFragmentArgs.fromSavedStateHandle(handle)
        }
    }
    ...
    fun fromBundle_readsEveryArgument() {
        ...
        assertEquals(args(), KalaAzarSuspectedListFragmentArgs.fromBundle(bundle))
    }
    ...
    fun fromBundle_throws_whenRequiredArgumentMissing() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            KalaAzarSuspectedListFragmentArgs.fromBundle(bundle)
        }
    }
    ...
    @Test
    fun actionKalaAzarSuspectedListFragmentToKalaAzarFormFragment_buildsDirections() {
        val d = KalaAzarSuspectedListFragmentDirections.actionKalaAzarSuspectedListFragmentToKalaAzarFormFragment(benId = 10L)
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = KalaAzarSuspectedListFragmentDirections.actionKalaAzarSuspectedListFragmentToKalaAzarFormFragment(benId = 10L)
        assertEquals(d, same)
    ...
    fun actionGlobalPwAncFormFragment_buildsDirections() {
        val d = KalaAzarSuspectedListFragmentDirections.actionGlobalPwAncFormFragment(benId = 10L, hhId = "v2", visitNumber = 31, fromPmsma = true, lastItemClick = true)
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = KalaAzarSuspectedListFragmentDirections.actionGlobalPwAncFormFragment(benId = 10L, hhId = "v2", visitNumber = 31, fromPmsma = true, lastItemClick = true)
        assertEquals(d, same)
        assertEquals(d.hashCode(), same.hashCode())
        assertFalse(d.equals(null))
        assertFalse(d.equals(Any()))
