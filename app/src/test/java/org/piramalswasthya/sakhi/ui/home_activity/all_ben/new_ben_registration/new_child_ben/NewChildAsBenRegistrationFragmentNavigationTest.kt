...
class NewChildAsBenRegistrationFragmentNavigationTest {
    ...
    private fun args() = NewChildAsBenRegistrationFragmentArgs(hhId = 10L, relToHeadId = 21, benId = 30L, selectedBenId = 40L, gender = 51, isAddSpouse = 61)
    ...
    fun dataClassSynthetics_behaveAsValueType() {
        ...
        assertTrue(a.toString().contains("NewChildAsBenRegistrationFragmentArgs"))
    ...
    fun toSavedStateHandle_thenFromSavedStateHandle_roundTrips() {
        ...
        assertEquals(args(), NewChildAsBenRegistrationFragmentArgs.fromSavedStateHandle(handle))
    }
    ...
    fun fromSavedStateHandle_appliesDefaults_whenOptionalArgumentsMissing() {
        ...
        val a = NewChildAsBenRegistrationFragmentArgs.fromSavedStateHandle(handle)
    ...
    fun fromSavedStateHandle_throws_whenRequiredArgumentMissing() {
        assertThrows(IllegalArgumentException::class.java) {
            NewChildAsBenRegistrationFragmentArgs.fromSavedStateHandle(SavedStateHandle())
        }
    }
    ...
    fun fromSavedStateHandle_throws_whenRequiredArgumentIsNull() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            NewChildAsBenRegistrationFragmentArgs.fromSavedStateHandle(handle)
        }
    }
    ...
    fun fromBundle_readsEveryArgument() {
        ...
        assertEquals(args(), NewChildAsBenRegistrationFragmentArgs.fromBundle(bundle))
    }
    ...
    fun fromBundle_appliesDefaults_whenOptionalArgumentsMissing() {
        ...
        every { bundle.getLong("hhId") } returns 10L
        every { bundle.getInt("relToHeadId") } returns 21
        val a = NewChildAsBenRegistrationFragmentArgs.fromBundle(bundle)
        assertEquals(0L, a.benId)
        assertEquals(0L, a.selectedBenId)
        assertEquals(0, a.gender)
        assertEquals(0, a.isAddSpouse)
    ...
    fun fromBundle_throws_whenRequiredArgumentMissing() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            NewChildAsBenRegistrationFragmentArgs.fromBundle(bundle)
        }
    }
    ...
    fun actionNewBenRegFragmentSelf_buildsDirections() {
        val d = NewChildAsBenRegistrationFragmentDirections.actionNewBenRegFragmentSelf(hhId = 10L, relToHeadId = 21, benId = 30L, selectedBenId = 40L, gender = 51, isAddSpouse = 61)
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = NewChildAsBenRegistrationFragmentDirections.actionNewBenRegFragmentSelf(hhId = 10L, relToHeadId = 21, benId = 30L, selectedBenId = 40L, gender = 51, isAddSpouse = 61)
        assertEquals(d, same)
    ...
    fun actionGlobalPwAncFormFragment_buildsDirections() {
        val d = NewChildAsBenRegistrationFragmentDirections.actionGlobalPwAncFormFragment(benId = 10L, hhId = "v2", visitNumber = 31, fromPmsma = true, lastItemClick = true)
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = NewChildAsBenRegistrationFragmentDirections.actionGlobalPwAncFormFragment(benId = 10L, hhId = "v2", visitNumber = 31, fromPmsma = true, lastItemClick = true)
        assertEquals(d, same)
        assertEquals(d.hashCode(), same.hashCode())
        assertFalse(d.equals(null))
        assertFalse(d.equals(Any()))
    ...
    fun constructor_usesDefaults_whenOptionalArgumentsOmitted() {
        val a = NewChildAsBenRegistrationFragmentArgs(hhId = 10L, relToHeadId = 21)
        assertEquals(0L, a.benId)
        assertEquals(0L, a.selectedBenId)
        assertEquals(0, a.gender)
        assertEquals(0, a.isAddSpouse)
