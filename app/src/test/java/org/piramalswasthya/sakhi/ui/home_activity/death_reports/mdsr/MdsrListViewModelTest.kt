...
class MdsrListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: MdsrListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.mdsrList } returns flowOf(emptyList())
        viewModel = MdsrListViewModel(recordsRepo)
    }
