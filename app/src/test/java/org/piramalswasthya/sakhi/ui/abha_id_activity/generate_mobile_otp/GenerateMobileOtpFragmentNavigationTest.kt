...
class GenerateMobileOtpFragmentNavigationTest {
    ...
    private fun args() = GenerateMobileOtpFragmentArgs(txnId = "v1", mobileNumber = "v2")
    ...
    fun dataClassSynthetics_behaveAsValueType() {
        ...
        assertTrue(a.toString().contains("GenerateMobileOtpFragmentArgs"))
    ...
    fun toSavedStateHandle_thenFromSavedStateHandle_roundTrips() {
        ...
        assertEquals(args(), GenerateMobileOtpFragmentArgs.fromSavedStateHandle(handle))
    }

    @Test
    fun fromSavedStateHandle_throws_whenRequiredArgumentMissing() {
        assertThrows(IllegalArgumentException::class.java) {
            GenerateMobileOtpFragmentArgs.fromSavedStateHandle(SavedStateHandle())
        }
    }
    ...
    fun fromSavedStateHandle_throws_whenRequiredArgumentIsNull() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            GenerateMobileOtpFragmentArgs.fromSavedStateHandle(handle)
        }
    }
    ...
    fun fromBundle_readsEveryArgument() {
        ...
        assertEquals(args(), GenerateMobileOtpFragmentArgs.fromBundle(bundle))
    }
    ...
    fun fromBundle_throws_whenRequiredArgumentMissing() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            GenerateMobileOtpFragmentArgs.fromBundle(bundle)
        }
    }
    ...
    @Test
    fun actionGenerateMobileOtpFragmentToVerifyMobileOtpFragment_buildsDirections() {
        val d = GenerateMobileOtpFragmentDirections.actionGenerateMobileOtpFragmentToVerifyMobileOtpFragment(txnId = "v1", phoneNum = "v2", alternatePhoneNumber = "v3", name = "v4", phrAddress = "v5", abhaNumber = "v6", abhaResponse = "v7")
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = GenerateMobileOtpFragmentDirections.actionGenerateMobileOtpFragmentToVerifyMobileOtpFragment(txnId = "v1", phoneNum = "v2", alternatePhoneNumber = "v3", name = "v4", phrAddress = "v5", abhaNumber = "v6", abhaResponse = "v7")
        assertEquals(d, same)
    ...
    @Test
    fun actionGenerateMobileOtpFragmentToCreateAbhaFragment_buildsDirections() {
        val d = GenerateMobileOtpFragmentDirections.actionGenerateMobileOtpFragmentToCreateAbhaFragment(txnId = "v1", name = "v2", phrAddress = "v3", abhaNumber = "v4", abhaResponse = "v5")
        assertNotNull(d)
        assertTrue(d.actionId != 0)
        assertNotNull(d.arguments)
        assertTrue(d.toString().isNotEmpty())
        val same = GenerateMobileOtpFragmentDirections.actionGenerateMobileOtpFragmentToCreateAbhaFragment(txnId = "v1", name = "v2", phrAddress = "v3", abhaNumber = "v4", abhaResponse = "v5")
        assertEquals(d, same)
        assertEquals(d.hashCode(), same.hashCode())
        assertFalse(d.equals(null))
        assertFalse(d.equals(Any()))
