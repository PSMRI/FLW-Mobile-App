...
class NmdsrListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: NmdsrListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.nmdrList } returns flowOf(emptyList())
        viewModel = NmdsrListViewModel(recordsRepo)
    }
