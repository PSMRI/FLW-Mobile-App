...
class TBSuspectedListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: TBSuspectedListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.tbSuspectedList } returns flowOf(emptyList())
        viewModel = TBSuspectedListViewModel(recordsRepo)
    }
