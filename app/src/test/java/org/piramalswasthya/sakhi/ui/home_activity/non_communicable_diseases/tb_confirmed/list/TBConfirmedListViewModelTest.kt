...
class TBConfirmedListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: TBConfirmedListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.tbConfirmedList } returns flowOf(emptyList())
        viewModel = TBConfirmedListViewModel(recordsRepo)
    }
