...
class GdrListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: GdrListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.gdrList } returns flowOf(emptyList())
        viewModel = GdrListViewModel(recordsRepo)
    }
