...
class NonPregnantListViewModelTest : BaseViewModelTest() {

    @MockK private lateinit var recordsRepo: RecordsRepo

    private lateinit var viewModel: NonPregnantListViewModel

    @Before
    override fun setUp() {
        super.setUp()
        every { recordsRepo.hrpNonPregnantWomenList } returns flowOf(emptyList())
        viewModel = NonPregnantListViewModel(recordsRepo)
    }
