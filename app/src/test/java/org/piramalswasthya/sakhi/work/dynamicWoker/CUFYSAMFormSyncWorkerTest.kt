...
class CUFYSAMFormSyncWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): CUFYSAMFormSyncWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return CUFYSAMFormSyncWorker(context, params, preferenceDao, repository)
    }
