...
class CbacPushToAmritWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): CbacPushToAmritWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return CbacPushToAmritWorker(context, params, cbacRepo, preferenceDao)
    }
