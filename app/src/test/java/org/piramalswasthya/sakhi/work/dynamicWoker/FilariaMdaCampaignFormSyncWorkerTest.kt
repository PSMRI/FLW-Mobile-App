...
class FilariaMdaCampaignFormSyncWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): FilariaMdaCampaignFormSyncWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return FilariaMdaCampaignFormSyncWorker(context, params, preferenceDao, repository)
    }
