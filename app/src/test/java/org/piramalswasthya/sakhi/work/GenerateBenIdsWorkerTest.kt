...
class GenerateBenIdsWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): GenerateBenIdsWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return GenerateBenIdsWorker(context, params, benRepo, preferenceDao)
    }
