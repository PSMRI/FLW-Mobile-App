...
class PulsePolioCampaignFormSyncWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): PulsePolioCampaignFormSyncWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return PulsePolioCampaignFormSyncWorker(context, params, preferenceDao, repository)
    }
