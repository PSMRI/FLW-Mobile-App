...
class ORSCampaignFormSyncWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): ORSCampaignFormSyncWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return ORSCampaignFormSyncWorker(context, params, preferenceDao, repository)
    }
