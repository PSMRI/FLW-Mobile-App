...
class PushLeprosyFollowUpAmritWorkerTest : BaseRepositoryTest() {
    ...
    private fun worker(attempt: Int = 0): PushLeprosyFollowUpAmritWorker {
        val params = mockk<WorkerParameters>(relaxed = true)
        every { params.runAttemptCount } returns attempt
        return PushLeprosyFollowUpAmritWorker(context, params, leprosyRepo, preferenceDao)
    }
