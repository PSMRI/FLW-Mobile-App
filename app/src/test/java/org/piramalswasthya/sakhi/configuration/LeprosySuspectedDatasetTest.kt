...
class LeprosySuspectedDatasetTest : BaseViewModelTest() {
    ...
    fun `construction ENGLISH and HINDI`() {
        runCatching { LeprosySuspectedDataset(context, Languages.ENGLISH) }
        runCatching { LeprosySuspectedDataset(context, Languages.HINDI) }
